...
//Getting principal and financial manager accesses
    ...
    //Getting admissions officer accesses
    public function getFilteredAccessesA($userAccessInfo): array
    {
        $admissionsOfficerAccess = [];
        ...
        return array_filter(array_unique(array_merge($admissionsOfficerAccess)));
    }
}
