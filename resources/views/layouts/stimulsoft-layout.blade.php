<?php
require_once 'stimulsoft-package/stimulsoft/helper.php';
?>
        <!DOCTYPE html>
<html>
<head>
    ...
    <link href="{{ asset('stimulsoft-package/css/stimulsoft.viewer.office2013.whiteblue.css') }}" rel="stylesheet">

    <!-- Stimulsoft Reports.JS -->
    <script src="{{ asset('stimulsoft-package/scripts/stimulsoft.reports.js') }}" type="text/javascript"></script>

    <!-- Stimulsoft JS Viewer -->
    <script src="{{ asset('stimulsoft-package/scripts/stimulsoft.viewer.js') }}" type="text/javascript"></script>
    ...
    StiHelper::init('adapters/handler.php', 30);
    ?>
    ...
    <script type="text/javascript">
        ...
        Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("{{ asset('stimulsoft-package/stimulsoft/fonts/IRANSansX-Black.ttf') }}");
        Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("{{ asset('stimulsoft-package/stimulsoft/fonts/IRANSansX-Bold.ttf') }}");
        Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("{{ asset('stimulsoft-package/stimulsoft/fonts/IRANSansX-DemiBold.ttf') }}");
        Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("{{ asset('stimulsoft-package/stimulsoft/fonts/IRANSansX-Light.ttf') }}");
        Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("{{ asset('stimulsoft-package/stimulsoft/fonts/IRANSansX-Medium.ttf') }}");
        Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("{{ asset('stimulsoft-package/stimulsoft/fonts/IRANSansX-Regular.ttf') }}");
        Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("{{ asset('stimulsoft-package/stimulsoft/fonts/IRANSansX-Thin.ttf') }}");
        Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("{{ asset('stimulsoft-package/stimulsoft/fonts/IRANSansX-UltraLight.ttf') }}");
